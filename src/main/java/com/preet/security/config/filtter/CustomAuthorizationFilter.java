package com.preet.security.config.filtter;
...
import com.preet.security.config.security.SecurityConfig;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    private static boolean anyMatch(String uri) {
        String[] whiteList = SecurityConfig.AUTH_WHITELIST;
        for (String publicUri : whiteList) {
